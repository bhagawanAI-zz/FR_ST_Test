# build python first by following these commands
...
````console
$ ./configure --prefix=<ABSOLUTE_PATH where we want to build python> --exec-prefix=<ABSOLUTE_PATH where we want to build python> --enable-shared
````
...
- export python paths
````console
$ export PYTHONHOME=<ABSOLUTE_PATH where we want to build python>
$ export PYTHONPATH=<ABSOLUTE_PATH where we want to build python>
````
